									...
									<div class="item-info2" style="display: none">
										<div style="-webkit-box-flex:1">
											<div class="edit-quantity">
												...
												<p class="btn-input"><input type="tel" :max="good.info.limit ||5" min="1" :value="good.quantity"></p>
												<p class="btn-plus"><a class="btn plus" :data-sellerId="key" :data-skuId="good.skuId" :max="good.info.limit || 5" @click="changeQun('add',$event)"></a></p>
											</div>
											<div class="edit-sku" >
		...
		created(){
			...
			if(localStorage.jhsCart){
				...
				for(var i in this.items){
					var that = this;
					if(that.items[i].goods.length>=1){
